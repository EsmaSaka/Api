 ...
 * When users sends a GET request to "/location"
    ...
    public void  test5() {
        ...
        then()
                .assertThat().statusCode(200)
                .assertThat().body("sources.title",contains("BBC", "Forecast.io",
                                                                       "HAMweather", "Met Office", "OpenWeatherMap",
    ...
    public void  test6() {
        ...
        List<String> expected=List.of("BBC","Forecast.io",  //Arrays.asList i de kullanabilirsin
                "HAMweather", "Met Office", "OpenWeatherMap",
                "Weather Underground", "World Weather Online");
